...
@Component({
  selector: 'app-store-protection',
  templateUrl: './store-protection.component.html',
  styleUrls: ['./store-protection.component.scss'],
})
export class StoreProtectionComponent implements OnInit {
  ...
  constructor(
    ...
    private _movementsService: ProtectionService,
