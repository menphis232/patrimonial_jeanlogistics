...
@Component({
  selector: 'app-store-accident',
  templateUrl: './store-accident.component.html',
  styleUrls: ['./store-accident.component.scss']
})
export class StoreAccidentComponent implements OnInit {
  ...
  */
  ...
  getEditData(id: string): void {
    ...
    this.activatedRoute.params.subscribe(param => {
      ...
      if(param?.['id']){
        ...
        this._accidentService.show(param?.['id']).subscribe((response: any) => {
  ...
  save() {
    ...
    this._accidentService.store(this.mapData)
